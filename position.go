...
func (pos *Position) updateCastleRights(m *Move) CastleRights {
	...
	clear := func(marker string) { cr = strings.Replace(cr, marker, "", -1) }

	// Only clear rights when an actual castle occurs to keep Chess960 rights intact during PGN replay.
